...
const updatename = () => {
  ...
  <div className='w-full  h-screen bg-[lightblue] flex justify-center items-center'>
    <div className='md:w-[50%] max-sm:w-[90%] md:h-[50%] max-sm:h-full bg-white flex flex-col justify-evenly max-sm:justify-start max-sm:gap-8 md:pl-5  '>
      ...
      <button className="btn btn-primary md:w-[20vw] md:text-xl text-lg" onClick={updateimg}>Update image</button>
      ...
      <button className="btn btn-primary md:w-[20vw]  md:text-xl text-lg" onClick={updatename}>Update name</button>
